...
import { HeaderHamburger } from "@massds/mayflower-react";
  ...
  render() {
    return (
      <>
        <section
          data-nosnippet="true"
          className="ma__emergency-alerts js-accordion js-emergency-alerts"
        ...
        >
              ...
              <h2 className="ma__emergency-header">
                <span className="ma__emergency-header__label">
                  <svg aria-hidden="true" focusable="false">
                    <use xlinkHref="#d574f607e920816accab31d87cddd930.3" />
                  </svg>
                  <svg
            ...
            <div className="ma__emergency-alerts__container">
              <p className="ma__emergency-alert" tabindex="0">
                ...
                <span className="ma__emergency-alert__link">
                  <a
                    className="ma__content-link ma__content-link--chevron"
                    href="https://member.everbridge.net/index/406686158291020/#/signup"
                  >
                    <span>Read more</span>
                  </a>
                </span>
              ...
              <p className="ma__emergency-alert" tabindex="0">
                <span className="ma__emergency-alert__message">
                  For the latest information on COVID-19 Cases, Restrictions,
                  Business Relief{" "}
                  <span className="ma__emergency-alert__time-stamp">
                    Jan. 6th, 2021, 5:00 pm
                  </span>
                </span>
                <span className="ma__emergency-alert__link">
                  <a
          ...
          <div className="ma__emergency-alerts__interface js-accordion-link">
            <button className="ma__button-alert " type="button">
              <span className="ma__button-alert__hide">Hide</span>
              <span className="ma__button-alert__show">Show</span> Updates
            </button>
        ...
        <HeaderHamburger
          ...
          mainItems={[
            ...
            },
            {
              active: false,
              href:
                "/patterns/05-pages-section-landing/05-pages-section-landing.html",
              subNav: [
                {
                  href: "#",
            ...
            },
            {
              ...
              subNav: [
                ...
                {
                  href:
                    "/patterns/05-pages-topic-your-government/05-pages-topic-your-government.html",
