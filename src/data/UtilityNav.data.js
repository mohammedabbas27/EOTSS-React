  ...
  items: [
    ...
    },
    {
      ...
      panel: {
        description: {
          text:
            'The <a href="#">A-Z Organizations page</a> provides an alphabetical listing of government organizations, including commissions, departments, and bureaus.'
        }
      }
    },
    {
      ...
      panel: {
        description: {
          text:
            "These are the top requested sites you can log in to access state provided services"
        },
        links: [
          {
